...
public class LocateJoker_Test1 implements Runnable{
    @Override
    public void run() {
        Deck tdeck = new Deck();
...
public class LocateJoker_Test2 implements Runnable{
    @Override
    public void run() {
        Deck tdeck = new Deck();
        Deck.Card c1 = tdeck.new PlayingCard(Deck.suitsInOrder[0], 1); //AC
...
public class LocateJoker_Test3 implements Runnable{
    @Override
    public void run() {
        Deck tdeck = new Deck();
        Deck.Card c1 = tdeck.new PlayingCard(Deck.suitsInOrder[0], 1); //AC
