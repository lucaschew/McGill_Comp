...
class MoveCard_CheckPrev2 implements Runnable {
    ...
    public void run() {
        Deck deck = new Deck();
        Deck.Card[] cards = new Deck.Card[]{
                deck.new PlayingCard(Deck.suitsInOrder[0], 1), //AC
                deck.new PlayingCard(Deck.suitsInOrder[0], 3), //3C
                deck.new PlayingCard(Deck.suitsInOrder[0], 5), //5C
                deck.new Joker("black"),					   //BJ
                deck.new PlayingCard(Deck.suitsInOrder[1], 2), //2D
                deck.new PlayingCard(Deck.suitsInOrder[2], 4), //4H
                deck.new PlayingCard(Deck.suitsInOrder[3], 6)  //6S
        };
...
class tripleCut_Test1 implements Runnable{
    @Override
    public void run() {
        ...
        Deck.Card[] cards = new Deck.Card[]{
                deck.new PlayingCard(Deck.suitsInOrder[0], 1), //AC
                deck.new PlayingCard(Deck.suitsInOrder[0], 2), //2C
                deck.new Joker("black"),					   //BJ
                deck.new PlayingCard(Deck.suitsInOrder[0], 3), //3C
                deck.new Joker("red"),						   //RJ
                deck.new PlayingCard(Deck.suitsInOrder[0], 4), //4C
                deck.new PlayingCard(Deck.suitsInOrder[0], 5), //5C
        };
        ...
        deck.tripleCut(cards[2], cards[4]);
        
        Deck.Card[] expected = new Deck.Card[]{
                cards[5], cards[6], cards[2], cards[3],
                cards[4], cards[0], cards[1]};
        
        Deck.Card tempHead = deck.head;
        
        for (int i = 0; i < deck.numOfCards; i++) {
        	if (expected[i].getValue() != tempHead.getValue()) {
        		throw new AssertionError("Not Triple Cut Correctly");
        	}
...
class counterCut_Test1 implements Runnable {
	...
	public void run() {
        ...
        Deck.Card[] expected = new Deck.Card[]{
                cards[5], cards[0], cards[1], cards[2],
...
class Cipher_Test1 implements Runnable {
	...
	public void run() {
        ...
        Deck.Card[] cards = new Deck.Card[]{
                deck.new PlayingCard(Deck.suitsInOrder[0], 1),
                deck.new PlayingCard(Deck.suitsInOrder[0], 4),
                deck.new PlayingCard(Deck.suitsInOrder[0], 7),
                deck.new PlayingCard(Deck.suitsInOrder[0], 10),
                deck.new PlayingCard(Deck.suitsInOrder[0], 13),
                deck.new PlayingCard(Deck.suitsInOrder[1], 3),
                deck.new PlayingCard(Deck.suitsInOrder[1], 6),
                deck.new PlayingCard(Deck.suitsInOrder[1], 9),
                deck.new PlayingCard(Deck.suitsInOrder[1], 12),
                deck.new Joker("black"),
                deck.new PlayingCard(Deck.suitsInOrder[0], 3),
                deck.new PlayingCard(Deck.suitsInOrder[0], 6),
                deck.new PlayingCard(Deck.suitsInOrder[0], 9),
                deck.new PlayingCard(Deck.suitsInOrder[0], 12),
                deck.new PlayingCard(Deck.suitsInOrder[1], 2),
                deck.new PlayingCard(Deck.suitsInOrder[1], 5),
                deck.new PlayingCard(Deck.suitsInOrder[1], 8),
                deck.new PlayingCard(Deck.suitsInOrder[1], 11),
                deck.new Joker("red"),
                deck.new PlayingCard(Deck.suitsInOrder[0], 2),
                deck.new PlayingCard(Deck.suitsInOrder[0], 5),
                deck.new PlayingCard(Deck.suitsInOrder[0], 8),
                deck.new PlayingCard(Deck.suitsInOrder[0], 11),
                deck.new PlayingCard(Deck.suitsInOrder[1], 1),
                deck.new PlayingCard(Deck.suitsInOrder[1], 4),
                deck.new PlayingCard(Deck.suitsInOrder[1], 7),
                deck.new PlayingCard(Deck.suitsInOrder[1], 10),
                deck.new PlayingCard(Deck.suitsInOrder[1], 13),
        };
        ...
        SolitaireCipher sc = new SolitaireCipher(deck);
        String result = sc.encode("Is That You, Bob?");
        
        if (result.equals("TBQOKSJZBJXE")) {
        	System.out.println("Test Passed");
        } else {
...
class Cipher_Test2 implements Runnable {
	...
	public void run() {
        ...
        SolitaireCipher sc = new SolitaireCipher(deck);
        String result = sc.decode("TBQOKSJZBJXE");
        
        if (result.equals("ISTHATYOUBOB")) {
        	System.out.println("Test Passed");
        } else {
...
public class A2_Minitester_Updated1 {
    ...
    static String[] tests = {
        ...
        "assignment2.tripleCut_Test1",
        "assignment2.counterCut_Test1",
        "assignment2.Cipher_Test1",
        "assignment2.Cipher_Test2"
    };
